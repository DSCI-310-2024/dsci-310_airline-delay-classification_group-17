...
def main():
    """
    Generate visualization plots based on the predictions and actual flight delays.

    Reads prediction results and flight test data, preprocesses the data,
    generates four different visualization plots, and saves them as PNG or HTML files.

    Returns:
    None
    """
    # Read prediction results and flight test data
    ...
    # Map numerical values to categorical labels for visualization
    ...
    def plot1():
        """
        Generate and save a bar chart comparing predicted flight delays by month with actual flight delays.
        """
        month_vs_prediction = alt.Chart(flight_test_predict, width=300, height=200, title="Month and Predicted Flight Delay").mark_bar().encode(
            x=alt.X("MONTH", title="Month", axis=alt.Axis(labelAngle=0), sort=["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]),
            xOffset="prediction",
        ...
        month_vs_real = alt.Chart(flight_test_predict, width=300, height=200, title="Month and Actual Flight Delay").mark_bar().encode(
            x=alt.X("MONTH", title="Month", axis=alt.Axis(labelAngle=0), sort=["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]),
            xOffset="DEP_DEL15",
            y=alt.Y("count()", title="Number of Flights"),
    ...
    def plot2():
        """
        Generate and save a bar chart comparing predicted flight delays by day of the week with actual flight delays.
        """
        day_vs_prediction = alt.Chart(flight_test_predict, width=300, height=250, title="Day of the Week and Predicted Flight Delay").mark_bar().encode(
            x=alt.X("DAY_OF_WEEK", title="Day of the Week", axis=alt.Axis(labelAngle=0), sort=["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"]),
            xOffset="prediction",
            y=alt.Y("count()", title="Number of Flights"),
            color=alt.Color("prediction", title="Model Prediction"),
        ...
        day_vs_real = alt.Chart(flight_test_predict, width=300, height=250, title="Day of the Week and Actual Flight Delay").mark_bar().encode(
            x=alt.X("DAY_OF_WEEK", title="Day of the Week", axis=alt.Axis(labelAngle=0), sort=["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"]),
            xOffset="DEP_DEL15",
            y=alt.Y("count()", title="Number of Flights"),
            color=alt.Color("DEP_DEL15", title="Actual"),
    ...
    def plot3():
        """
        Generate and save a bar chart comparing flight carriers with predicted flight delays and actual flight delays.
        """
        carrier_vs_prediction = alt.Chart(flight_test_predict, width=400, height=300, title="Flight Carriers and Predicted Flight Delay").mark_bar().encode(
        ...
        carrier_vs_real = alt.Chart(flight_test_predict, width=400, height=300, title="Flight Carriers and Actual Flight Delay").mark_bar().encode(
            x=alt.X("CARRIER_NAME", title="Airline Carrier", axis=alt.Axis(labelAngle=-45)),
            xOffset="DEP_DEL15",
            y=alt.Y("count()", title="Number of Flights"),
            color=alt.Color("DEP_DEL15", title="Actual"),
    ...
    def plot4():
        """
        Generate and save an interactive scatter plot showing the relationship between numerical features and flight delays.
        """
        ...
        drop_down_chart = alt.Chart(melt_flight_predict, width=1000, height=400).mark_circle(opacity=0.4).encode(
