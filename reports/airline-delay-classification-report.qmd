...
![Distribution of flights over the year in each month with the model's prediction of flight delay and actual flight delay.](../results/04_fig_month-vs-prediction-actual.png){#fig-month width=90%}
...
```{python}
# interactive viz for numeric features vs. month
```

![Interactive plot of flight month vs. selected numeric feature and the model's prediction if the flight will be delayed or not.](../results/07_fig_numeric-feats-interactive-viz.png){#fig-interactive width=90%}
